<div class="panel panel-default">
  ...
  <div class="panel-body">
    <div class="form-group">
      ...
      <div class="col-md-9"> <?php echo form_input(array('name'=>'email','class'=>'form-control','disabled'=>TRUE),set_value('email',$user['email']));?> </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-md-9"> <?php echo form_dropdown(array('name'=>'title','class'=>'form-control'),array('นาย'=>'นาย','นาง'=>'นาง','นางสาว'=>'นางสาว'),set_value('title',$user['title']));?> </div>
    </div>
    <div class="form-group">
      <?php echo form_label('ชื่อ','',array('class'=>'control-label col-md-3'));?>
      <div class="col-md-9"> <?php echo form_input(array('name'=>'firstname','class'=>'form-control'),set_value('firstname',$user['firstname']));?> </div>
    </div>
    <div class="form-group">
      <?php echo form_label('นามสกุล','',array('class'=>'control-label col-md-3'));?>
      <div class="col-md-9"> <?php echo form_input(array('name'=>'lastname','class'=>'form-control'),set_value('lastname',$user['lastname']));?> </div>
    </div>
    <?php if ($this->ion_auth->is_admin()): ?>
      <div class="form-group">
        <label for="" class="control-label col-md-3">กลุ่มผู้ใช้</label>
        <div class="col-md-9"> <?=form_dropdown(array('name'=>'groups[]','class'=>'form-control','multiple'=>TRUE),$groups,set_value('groups[]',$currentGroups));?> </div>
      </div>
      <div class="form-group">
        <label for="" class="control-label col-md-3">สถานะ</label>
        <div class="col-md-9"> <?=form_dropdown(array('name'=>'active','class'=>'form-control'),array('0'=>'ปิดใช้งาน','1'=>'เปิดใช้งาน'),set_value('active',$user['active']));?> </div>
      </div>
    <?php endif ?>
  </div>
  <div class="form-group">
