...
<div class="col-md-12">
  <div class="panel panel-default">
    <div class="panel-heading"> <h3 class="panel-title">เพิ่มข้อมูลอุปกรณ์</h3> </div>
    <div class="panel-body">
      <div class="form-group">
        <?=form_label('ชื่ออุปกรณ์','',array('class'=>'control-label col-md-3'));?>
        <div class="col-md-9"> <?=form_input(array('name'=>'name','class'=>'form-control'),set_value('name'));?> </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="col-md-9"> <?=form_input(array('name'=>'','class'=>'form-control','disabled'=>TRUE,'value'=>date('d-m-Y',time())));?> </div>
      </div>
      <div class="form-group">
        <?=form_label('วันที่อัพเดท','',array('class'=>'control-label col-md-3'));?>
        <div class="col-md-9"> <?=form_input(array('name'=>'','class'=>'form-control','disabled'=>TRUE));?> </div>
      </div>
      <div class="form-group">
        <?=form_label('ข้อมูลอุปกรณ์','',array('class'=>'control-label col-md-3'));?>
        <div class="col-md-9"> <?=form_textarea(array('name'=>'description','class'=>'form-control textarea'));?> </div>
      </div>
      <div class="form-group">
          ...
          <?php foreach ($assets as $value) : ?>
            <div class="col-sm-1 col-md-2 col-lg-3">
              <label class="thumbnail img-responsive img-thumbnail">
                ...
                <?=form_checkbox('attachments[]',$value['id']);?>
              </label>
            </div>
          <?php endforeach; ?>
        </div>
