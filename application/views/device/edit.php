  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <div class="form-group">
        ...
        <div class="col-md-9"> <?=form_dropdown(array('name'=>'type','class'=>'form-control'),$tp,set_value('type',$device['type']));?> </div>
      </div>
      <div class="form-group">
        <?=form_label('ประเภทอุปกรณ์','',array('class'=>'control-label col-md-3'));?>
        <?php $ct = array(''=>'เลือกรายการ'); ?>
        <div class="col-md-9"> <?=form_dropdown(array('name'=>'category','class'=>'form-control'),$ct,set_value('category',$device['category']));?> </div>
      </div>
      <div class="form-group">
